...
//  }
  ...
  Future<void> localGetPagesAttrsInfo() async {
    ...
    if (pageDetail != null) {
      setState(() {
        pageTitle = pageDetail['title'] as String ?? '请加入title';
...
//    print('pagesList[pageId]>>> ${pagesList[pageId]}');
  ...
  Future<String> getContentOnline() async {
    ...
    setState(() {
      pageTitle = targetPage['title'] as String ?? 'xxx';
      author = targetPage['author'] as String;
      email = targetPage['email'] as String;
    });

    String pageName = (targetPage['name'] as String) +
        "_" +
        (targetPage['author'] as String) +
        "_" +
