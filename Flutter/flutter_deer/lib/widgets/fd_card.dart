...
class FdCard extends StatelessWidget {
  const FdCard({Key? key, required this.child, this.color, this.shadowColor}):super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final Color _backgroundColor = color ?? (isDark? FdColors.dark_bg_gray_: Colors.white);
